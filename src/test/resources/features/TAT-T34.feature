Feature: Login and logout with username_servicecardnumber_email address UAT1
    @TestCaseKey=TAT-T34
    Scenario: Login and logout with username_servicecardnumber_email address UAT1
