...
public class Endpoints_UAT3 {
    ...
    public Response EnrolmentUser(Enrolment enrolment) {
        ...
        Assertions.assertEquals( 201, response.statusCode(), "EnrolmentUser failed: Expected status code 201 but got " + response.statusCode() + ". Response body: " + response.getBody().asString());
        return response;
    }
    ...
    public Response updateUser_2FA(){
        ...
        // CHANGED: Use JUnit 5 Assertions.assertEquals
        Assertions.assertEquals( 204, response.statusCode(), "updateUser_2FA failed: Expected status code 204 but got " + response.statusCode() + ". Response body: " + response.getBody().asString());
        return response;
    }
    ...
    public Response requestTAN_usingMobileNumber(){
        ...
        // CHANGED: Use JUnit 5 Assertions.assertEquals
        Assertions.assertEquals( 201, response.statusCode(), "requestTAN_usingMobileNumber failed: Expected status code 201 but got " + response.statusCode() + ". Response body: " + response.getBody().asString());
        System.out.println("Body "+ response.getBody().asString());
        return response;
    }
    ...
    public Response requestTAN_usingMobileNumberE2E(String custNo){
        ...
        response = given()
                ...
                .post(dataProvider.getUAT3_BaseHost() +"/validation/v1/testing/me/sms");
        // CHANGED: Use JUnit 5 Assertions.assertEquals
        Assertions.assertEquals( 201, response.statusCode(), "requestTAN_usingMobileNumberE2E failed: Expected status code 201 but got " + response.statusCode() + ". Response body: " + response.getBody().asString());
        System.out.println("Body "+ response.getBody().asString());
        return response;
    }
    ...
    public Response getCustNo(String email) {
        ...
        // CHANGED: Use JUnit 5 Assertions.assertEquals
        Assertions.assertEquals( 200, response.statusCode(), "getCustNo failed: Expected status code 200 but got " + response.statusCode() + ". Response body: " + response.getBody().asString());
...
//              .queryParam("userId", member.getCustNo())
                .post(dataProvider.getUAT3_BaseHost() +"/validation/v1/testing/me/sms");
        // CHANGED: Use JUnit 5 Assertions.assertEquals
        Assertions.assertEquals( 201, response.statusCode(), "requestTAN_usingMobileNumberForActiveUser failed: Expected status code 201 but got " + response.statusCode() + ". Response body: " + response.getBody().asString());
        System.out.println("Response Code "+ response.statusCode());
        System.out.println("Body "+ response.getBody().asString());
        return response;
    }
...
//
    ...
    public Response enrollmentTDM(EnrollmentPayLoad enrollmentPayLoad, String userType1,String userType2, String tenant){
        ...
        // CHANGED: Use JUnit 5 Assertions.assertEquals
        Assertions.assertEquals( 200, response.statusCode(), "enrollmentTDM failed: Expected status code 200 but got " + response.statusCode() + ". Response body: " + response.getBody().asString());
        System.out.println("Response Code "+ response.statusCode());
        System.out.println("Body "+ response.getBody().asString());
        return response;
