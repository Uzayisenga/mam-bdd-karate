...
// Corrected import for DataModel_API_Request, removing potential 'com.' prefix and duplicates
...
//                .post( dataProvider.getBaseHost() + "/user/v3/enrolment" );
        ...
        Assertions.assertEquals( 202, response.statusCode(), "EnrolmentUser failed: Expected status code 202 but got " + response.statusCode() + ". Response body: " + response.getBody().asString());
        return response;
    }
...
//                .post( dataProvider.getBaseHost() + "/v1/user/enrolment");
        ...
        // CHANGED: Use JUnit 5 Assertions.assertEquals
        Assertions.assertEquals( 201, response.statusCode(), "EnrolmentUserTravelid failed: Expected status code 201 but got " + response.statusCode() + ". Response body: " + response.getBody().asString());
        return response;
    }
...
//                .log().all()
        ...
        // CHANGED: Use JUnit 5 Assertions.assertEquals
        Assertions.assertEquals( 204, response.statusCode(), "ResetPinPasswrod failed: Expected status code 204 but got " + response.statusCode() + ". Response body: " + response.getBody().asString());
...
//                .post( dataProvider.getBaseHost() + "/v1/user/enrolment");
        // CHANGED: Use JUnit 5 Assertions.assertEquals
        Assertions.assertEquals( 204, response.statusCode(), "ResetPinPasswroduat2 failed: Expected status code 204 but got " + response.statusCode() + ". Response body: " + response.getBody().asString());
        return response;
    }
...
//                .post( dataProvider.getBaseHost() + "/user/v3/enrolment" );
        ...
        // CHANGED: Use JUnit 5 Assertions.assertEquals
        Assertions.assertEquals( 202, response.statusCode(), "EnrolmentTravelidUser failed: Expected status code 202 but got " + response.statusCode() + ". Response body: " + response.getBody().asString());
        return response;
    }
    ...
    public Response EnrolmentBasicUser(BasicUserEnrolment basicUserEnrolment) {
        ...
        // CHANGED: Use JUnit 5 Assertions.assertEquals
        Assertions.assertEquals( 201, response.statusCode(), "EnrolmentBasicUser failed: Expected status code 201 but got " + response.statusCode() + ". Response body: " + response.getBody().asString());
        return response;
    }
    ...
    public Response Login(String username, String password) {
        ...
        // CHANGED: Use JUnit 5 Assertions.assertEquals
        Assertions.assertEquals( 201, response.statusCode(), "Login failed: Expected status code 201 but got " + response.statusCode() + ". Response body: " + response.getBody().asString());
    ...
    public Response UpdateStatus() {
        ...
        // CHANGED: Use JUnit 5 Assertions.assertEquals
        Assertions.assertEquals( 200, response.statusCode(), "UpdateStatus failed: Expected status code 200 but got " + response.statusCode() + ". Response body: " + response.getBody().asString());
        return response;
    }
    ...
    public Response AccountStatement(){
        ...
        // CHANGED: Use JUnit 5 Assertions.assertEquals
        Assertions.assertEquals( 200, response.statusCode(), "AccountStatement failed: Expected status code 200 but got " + response.statusCode() + ". Response body: " + response.getBody().asString());
        return response;
    }
    ...
    public Response updateToTravelID() {
        ...
        // CHANGED: Use JUnit 5 Assertions.assertEquals
        Assertions.assertEquals( 204, response.statusCode(), "updateToTravelID failed: Expected status code 204 but got " + response.statusCode() + ". Response body: " + response.getBody().asString());
        dataProvider.setCookies(response.getDetailedCookies());
        return response;
    }
...
//        System.out.println(dataProvider.getBaseOrigin());
        ...
        // CHANGED: Use JUnit 5 Assertions.assertEquals
        Assertions.assertEquals( 200, response.statusCode(), "GetDetails failed: Expected status code 200 but got " + response.statusCode() + ". Response body: " + response.getBody().asString());
        return response;
    }
...
//                .log().all()
                ...
                .delete( dataProvider.getUAT2_BaseHost() + "/user/v3/password" );
        // CHANGED: Use JUnit 5 Assertions.assertEquals
        Assertions.assertEquals( 204, response.statusCode(), "ResetPinPasswrod_uat2 failed: Expected status code 204 but got " + response.statusCode() + ". Response body: " + response.getBody().asString());
...
//                .post( dataProvider.getBaseHost() + "/v1/user/enrolment");
        // CHANGED: Use JUnit 5 Assertions.assertEquals
        Assertions.assertEquals( 204, response.statusCode(), "ResetPinPasswrod_uat2f failed: Expected status code 204 but got " + response.statusCode() + ". Response body: " + response.getBody().asString());
        return response;
    }
}
