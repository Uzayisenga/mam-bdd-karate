...
@ConfigurationParameter(key = PLUGIN_PROPERTY_NAME, value = "pretty")
// CRITICAL FIX: Changed JSON report output path to 'target/cucumber/Cucumber.json'
// This matches the actual location shown in your Jenkins workspace screenshot.
@ConfigurationParameter(key = PLUGIN_PROPERTY_NAME, value = "json:target/cucumber/Cucumber.json")
// Also updated HTML report path for consistency, placing it in the same 'target/cucumber' directory.
