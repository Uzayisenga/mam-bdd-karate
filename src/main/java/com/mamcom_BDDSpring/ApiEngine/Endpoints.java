...
import com.mamcom_BDDSpring.DataModel_API_Request.EnrollmentPayLoad;
...
import com.mamcom_BDDSpring.DataModel_API_Request.BasicUserEnrolment;
...
//              .queryParam("userId", member.getCustNo())
    ...
    public Response userEnebledAllInOneUser() {
        ...
        response = given()
                ...
                .when()
                .put(dataProvider.getBaseHost() + "/v1/user/"+member.getCustNo()+"/permission/all-in-one");
...
//                .body( jsonObjectGenerator.getJsonBody(jsonObjectGenerator.createAllInOneBody()) )
                .when()
                .get(dataProvider.getBaseHost() + "/v1/user/"+member.getCustNo()+"/permission");
//                .put(dataProvider.getBaseHost() + "/v1/user/me/permission/all-in-one");
        System.out.println("Response Code "+ response.statusCode());
        System.out.println("Body "+ response.getBody().asString());
        System.out.println("----------------");
...
//                .body( jsonObjectGenerator.getJsonBody(jsonObjectGenerator.createAllInOneBody()) )
                .when()
                .get(dataProvider.getBaseHost() + "/v1/user/"+member.getCustNo()+"/subscription");
//                .put(dataProvider.getBaseHost() + "/v1/user/me/permission/all-in-one");
        System.out.println("Response Code "+ response.statusCode());
        System.out.println("Body "+ response.getBody().asString());
        return response;
