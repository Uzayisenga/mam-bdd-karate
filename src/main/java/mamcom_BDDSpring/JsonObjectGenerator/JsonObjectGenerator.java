package mamcom_BDDSpring.JsonObjectGenerator;
...
import mamcom_BDDSpring.dataProvider.memberStatus;
...
public class JsonObjectGenerator {
    ...
    @LazyAutowired
    private mamcom_BDDSpring.dataProvider.SampleSecound SampleSecound;
